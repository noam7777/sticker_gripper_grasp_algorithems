function max_load = numerical_analisis_peeked_cylinder(sO,l_init,s_tot,gamma,n_film,peal_vel_model,full_peal_animation,path_to_exp_csv,plot_all_streamlines,plot_optimal_sticker_state,sigma,n_seeds)
